...
public class Spy
{
    ...
    public string CollectGettersAndSetters(string className)
    {
        ...
        var classType = Type.GetType(className);
        var getters = classType.GetMethods(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static |
        ...
        var setters = classType.GetMethods(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static |
                                           BindingFlags.Instance)
                                            .Where(m => m.Name.StartsWith("set_"));
